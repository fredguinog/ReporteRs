...
doc <- chart_updateData(x=doc, bookmark ='CHART1', newData = df, ncolxaxis = 2L)

writeDoc(doc, paste0(home, '/Doc.docm'))

# NOW OPEN THE Doc1.docm FILE. WHEN THE SECURITY WARNING "MACROS
