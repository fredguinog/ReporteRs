...
Function `add.plot.interactivity` will let you add interactivity in 
**base** plots. It let you specify:

* click actions (javascript) on points, lines and polygons
* double click actions (javascript) on points, lines and polygons
* tooltips labels (as html code)

**See [addPlot](./addPlot.html) for more details.**
